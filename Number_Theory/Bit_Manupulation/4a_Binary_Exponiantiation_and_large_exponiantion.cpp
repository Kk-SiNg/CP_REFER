...
//M2:- BInary exponiantion--->recursive_method: this method is like divide and conquore,i.e. we are using top element on stack to build
...
//1. a <= 1e18, just change the data types to long long, since for every "a" or "product" the final stored result is always <=M
...
// check out large_exponiantion when b<= 1e18(file:///C:\Users\karti\Desktop\CPP_Refer\Number_Theory\Bit_Manupulation\4c_large_exponiantion_with_ETF_and_Eulers_Theoram.cpp)
int main(){
